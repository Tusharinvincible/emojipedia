...
const EmojiArray=[
{
    ...
    emoji:"😀",
    name:"Grinning Face",
    meaning:`The happy smiling face is one of the most common emojis and universally applicable:
     you just want to say hello, express joy or excitement about something or brighten up a short text.`,
},
...
},
{
    ...
    emoji:"😊",
    name:" Smiling Face",
    meaning:`I am as merry as a lark! Completely satisfied and speechless. Expression of bliss. Shy grin in response to a nice compliment or something great that happened.`
},
{
    id:11,
    emoji:"😇",
...
},
{
    ...
    meaning:`Face With Stuck-Out Tongue`
},
{
    id:23,
    emoji:"🤨",
...
},
{
    ...
    emoji:"🤓",
    name:"Nerd Face",
    meaning:`Huge glasses, awkward smile and buck teeth. Used humorously or ironically for nerds or to express how smart you are. Stereotype of a nerd; a smart but funny-dressed person with social deficits.Mahi Gohil`
}
]
